...
const PERMISSION_MODULES_BASE = {
  settings: {
    label: 'Settings',
    modules: {
      districts:          { label: 'Districts',          actions: ['add', 'edit', 'delete', 'view'] },
      designations:       { label: 'Designations',       actions: ['add', 'edit', 'delete', 'view'] },
      grades:             { label: 'Grades',             actions: ['add', 'edit', 'delete', 'view'] },
      departments:        { label: 'Departments',        actions: ['add', 'edit', 'delete', 'view'] },
      department_users:   { label: 'Department Users',   actions: ['add', 'edit', 'delete', 'view'] },
      nationalities:      { label: 'Nationalities',      actions: ['add', 'edit', 'delete', 'view'] },
      tests:              { label: 'Exam Test & Fee',    actions: ['add', 'edit', 'delete', 'view'] },
      cities:             { label: 'Cities',             actions: ['add', 'edit', 'delete', 'view'] },
      exam_centers:       { label: 'Exam Center',        actions: ['add', 'edit', 'delete', 'view'] },
      qualifications:     { label: 'Qualifications',     actions: ['add', 'edit', 'delete', 'view'] },
