...
export const MENU_ITEMS = [
  ...
  },
  {
    ...
    // Grouped into 4 categories (General / Main Website / Requisition &
    // Advertisement / Examination & Result) instead of one long flat list.
    // Permission keys are derived from each leaf's URL path (see
    // permissionRegistry.js resolveKey), not from menu nesting, so grouping
    // here doesn't change any existing role/permission data.
    submenu: [
      {
        label: "General",
      ...
      {
        label: "Main Website",
        path: "/dashboard/settings/commission-members",
        icon: Landmark,
        children: [
      ...
      {
        label: "Requisition & Advertisement",
        ...
        children: [
          ...
          { label: "Terms & Conditions",     path: "/dashboard/settings/terms-conditions",       icon: ScrollText },
        ],
      },
      {
        ...
        children: [
          ...
          { label: "CCE Groups",             path: "/dashboard/settings/groups",                    icon: Boxes },
          { label: "Roll No & Interview Slip Instructions", path: "/dashboard/settings/roll-number-slip-instructions", icon: Hash },
