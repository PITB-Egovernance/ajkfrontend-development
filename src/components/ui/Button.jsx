...
const Button = ({ children, variant = 'primary', size = 'md', disabled = false, className = '', ...props }) => {
  const variants = {
    primary: 'bg-gradient-to-br from-emerald-950 via-emerald-900 to-emerald-950 text-white shadow-md hover:shadow-lg hover:from-emerald-900 hover:to-emerald-950',
