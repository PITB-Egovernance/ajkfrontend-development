...
const AnnexAList = () => {
  ...
  const fetchAnnexAList = async (page = 1) => {
    setLoading(true);
    try {
      const response = await fetch(`${Config.apiUrl}/annex-a/list?page=${page}`, {
        method: 'GET',
        headers: {
  ...
  const openEditModal = async (id) => {
    ...
    try {
      const response = await fetch(`${Config.apiUrl}/annex-a/edit/${id}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
      ...
      if (response.ok && result.success) {
        ...
        toast.success('Form loaded', { id: loadingToast });
      } else {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await fetch(`${Config.apiUrl}/annex-a/${editFormData.job_detail_id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`${Config.apiUrl}/annex-a/${selectedAnnex.id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2">
                        <Button
                          size="sm"
                          variant="ghost"
                          onClick={() => viewAnnexDetails(annex.id)}
                          className="gap-1"
                        >
                        ...
                        <Button
                          size="sm"
                          variant="ghost"
                          onClick={() => openEditModal(annex.job_detail_id)}
      ...
      <AnimatePresence>
        {showEditModal && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setShowEditModal(false)}>
            ...
            >
              <div className="sticky top-0 bg-gradient-to-br from-blue-500 to-indigo-600 p-6 border-b z-10">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
