// Shared across CCE pages that let the admin pick an advertisement/job post —
// Screening Results, Master Date Sheet — wherever the backend annotates each
// advertisement with `clubbed_advertisement_ids` (see
